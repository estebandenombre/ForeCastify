...
<body>
  <nav class="navbar ocultar" id="barra_nav">
      ...
      <ul class="nav-links">
        ...
        <a href="metrics.php"><button id="ML_Link"><img src="/build/img/metrics2.png" alt="MA"></button></a>
                ...
                <div class="table-list">
                    <?php
                        ...
                        while ($row = $result->fetch_row()) {
                            ...
                            echo "<li draggable='true' class='table animate__animated animate__fadeInDown animate__delay-2s' data-tabla-id='" . $row[0] . "'>" . $row[0] . "</li>";
